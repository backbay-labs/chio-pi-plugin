...
for case, port, cutpoint, target in [('pi-after-receipt-r1', 58512, 'after-receipt', '/workspace/uncertain.txt'),
                                     ('pi-before-admission-r1', 58513, 'before-admission', '/workspace/before-fault.txt')]:
    ...
    delta = len(after['dispatch'])-len(before['dispatch']); expected_effects=1 if cutpoint=='after-receipt' else 0
