...
Pi resumed its retained native session file after the crash. Its native child reported unresolved provider/tool failure while the parent exited from SIGKILL.
